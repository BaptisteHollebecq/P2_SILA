...
Shader "Custom/ToonCutOut"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 tex2DNode76 = tex2D( _BaseColor, uv_BaseColor );
			...
			float3 indirectNormal106 = normalizeResult170;
			float4 temp_output_184_0 = ( _HighlightTint * tex2D( _BaseColor, uv_BaseColor ) );
			...
			float3 temp_output_180_0 = (temp_output_184_0).rgb;
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float3 temp_output_230_0 = ( ase_lightColor.rgb * ase_lightAtten );
			...
			#endif //aseld
			float3 normalizeResult266 = normalize( ( ase_worldViewDir + ase_worldlightDir ) );
			float dotResult62 = dot( normalizeResult266 , normalizeResult170 );
			float dotResult54 = dot( normalizeResult170 , ase_worldlightDir );
			#ifdef _STATICHIGHLIGHTS_ON
				float staticSwitch195 = dotResult54;
			#else
			...
			float lerpResult159 = lerp( temp_output_214_0 , ( saturate( ( ( dotResult54 + _BaseCellOffset ) / _BaseCellSharpness ) ) * ase_lightAtten ) , _ShadowContribution);
			...
			float dotResult88 = dot( normalizeResult170 , ase_worldViewDir );
			c.rgb = ( ( lerpResult187 * temp_output_180_0 * temp_output_230_0 * pow( temp_output_189_0 , 1.5 ) * saturate( ( ( staticSwitch195 + _HighlightCellOffset ) / ( ( 1.0 - temp_output_189_0 ) * _HighlightCellSharpness ) ) ) ) + temp_output_158_0 + ( ( saturate( dotResult54 ) * pow( ( 1.0 - saturate( ( dotResult88 + _RimOffset ) ) ) , _RimPower ) ) * temp_output_180_0 * temp_output_230_0 * (_RimColor).rgb ) );
			c.a = 1;
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			#endif //aseld
			float dotResult54 = dot( normalizeResult170 , ase_worldlightDir );
			float lerpResult159 = lerp( temp_output_214_0 , ( saturate( ( ( dotResult54 + _BaseCellOffset ) / _BaseCellSharpness ) ) * 1 ) , _ShadowContribution);
			float2 uv_BaseColor = i.uv_texcoord * _BaseColor_ST.xy + _BaseColor_ST.zw;
			float4 tex2DNode76 = tex2D( _BaseColor, uv_BaseColor );
			float3 temp_output_158_0 = ( ( ( lerpResult117 * ase_lightColor.a * temp_output_214_0 ) + ( ase_lightColor.rgb * lerpResult159 ) ) * (( tex2DNode76 * _BaseTint )).rgb );
...
/*ASEBEGIN
Version=17700
0;0;1920;1019;3452.853;2679.762;4.569673;False;False
Node;AmplifyShaderEditor.CommentaryNode;226;-1832.326,-284.0287;Inherit;False;1370.182;280;Comment;4;82;52;170;109;Normals;0.5220588,0.6044625,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;109;-1782.326,-207.5193;Float;False;Property;_NormalScale;Normal Scale;13;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;82;-1450.72,-234.0287;Inherit;True;Property;_NormalMap;Normal Map;12;2;[Normal];[NoScaleOffset];Create;True;0;0;False;0;-1;None;cfc0d23131d5f244da30962d436205b2;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;241;-1004.874,473.4572;Inherit;False;835.6508;341.2334;Comment;2;53;54;N.L;1,0.8441375,0,1;0;0
Node;AmplifyShaderEditor.WorldNormalVector;52;-1131.937,-228.7886;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;53;-954.8744,635.6907;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalizeNode;170;-890.3013,-229.7322;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;251;648.5698,-1229.416;Inherit;False;2234.221;738.9581;Comment;15;184;180;181;177;81;172;175;62;195;174;173;171;261;260;265;Highlight;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;270;-1176.774,-859.8137;Inherit;False;646.2802;411.0602;Comment;4;268;267;269;266;Half Vector;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;242;1324.039,459.9366;Inherit;False;2744.931;803.0454;Comment;22;158;130;235;73;182;76;133;107;159;162;160;214;74;213;215;207;57;60;58;127;59;256;Base Color;1,0,0,1;0;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;267;-1090.581,-809.8137;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;268;-1126.774,-627.7534;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TexturePropertyNode;265;702.9667,-1000.244;Inherit;True;Property;_BaseColor;Base Color;1;0;Create;True;0;0;False;0;None;1b8ba7fb5a0a27145819eec83687e2b2;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.DotProductOpNode;54;-630.5826,560.256;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;59;1374.039,641.3355;Float;False;Property;_BaseCellOffset;Base Cell Offset;4;0;Create;True;0;0;False;0;0;0.16;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;243;1727.822,1561.833;Inherit;False;1926.522;520.1537;Comment;13;98;244;193;96;94;103;93;92;91;90;88;89;86;Rim Color;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;81;1259.063,-994.7416;Inherit;True;Property;_Highlight;Highlight;7;1;[NoScaleOffset];Create;True;0;0;False;0;-1;None;1b8ba7fb5a0a27145819eec83687e2b2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;269;-869.0379,-667.2365;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;60;1676.114,631.0218;Float;False;Property;_BaseCellSharpness;Base Cell Sharpness;3;0;Create;True;0;0;False;0;0.01;0.01;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;266;-715.4931,-669.4302;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;89;2072.556,1825.936;Float;False;Property;_RimOffset;Rim Offset;16;0;Create;True;0;0;False;0;0.6;0.252;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;233;1355.396,-187.3015;Inherit;False;828.4254;361.0605;Comment;4;115;118;117;119;Indirect Diffuse;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;173;1405.781,-660.3005;Float;False;Property;_HighlightCellOffset;Highlight Cell Offset;8;0;Create;True;0;0;False;0;-0.95;-0.901;-1;-0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;162;2155.415,983.4974;Float;False;Property;_ShadowContribution;Shadow Contribution;6;0;Create;True;0;0;False;0;0.5;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;261;2068.847,-870.2864;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;2577.555,1840.936;Float;False;Property;_RimPower;Rim Power;15;0;Create;True;0;0;False;0;0.4;0.197;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;240;-553.8864,1274.714;Inherit;False;717.6841;295.7439;Comment;3;229;228;230;Light Falloff;0.9947262,1,0.6176471,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;73;2975.755,1079.272;Float;False;Property;_BaseTint;Base Tint;2;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;247;1687.587,-2100.743;Inherit;False;1008.755;365.3326;Comment;4;106;188;186;187;Indirect Specular;1,1,1,1;0;0
Node;AmplifyShaderEditor.PowerNode;94;2881.555,1712.936;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;229;-503.8863,1460.457;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightColorNode;228;-458.1825,1324.714;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;172;2338.051,-797.9624;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;175;2553.936,-794.2497;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;230;-269.8872,1390.874;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;163;4530.104,808.9365;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;5309.991,721.0016;Float;False;True;-1;6;ASEMaterialInspector;0;0;CustomLighting;Custom/ToonCutOut;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.45;True;True;0;True;TransparentCutout;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;True;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0.03;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;88;0;170;0
WireConnection;88;1;86;0
WireConnection;57;0;58;0
WireConnection;57;1;60;0
WireConnection;62;0;266;0
WireConnection;62;1;170;0
...
ASEEND*/
//CHKSM=DAED8804AA1984ED3A3470CDC2360A7E9C11217E