...
Shader "Custom/CustomToonSnowDeposit"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 tex2DNode146 = UnpackScaleNormal( tex2D( _NormalMap, uv0_Albedo ), _NormalScale );
			...
			float temp_output_47_0 = saturate( ( ( dotResult43 * _SnowDeposit ) + ( ( ( 1.0 - ( ( 1.0 - ( ( _SnowHeight - _SnowHeightSetting ) + 0.3 ) ) * 70.0 ) ) + 6.0 ) * tex2DNode195.r ) ) );
...
/*ASEBEGIN
Version=17700
202;73;1261;656;5191.87;2941.931;7.303861;True;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;309;-7139.924,-3084.899;Inherit;False;0;156;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;146;-6742.134,-2822.689;Inherit;True;Property;_NormalMap;Normal Map;14;2;[Normal];[NoScaleOffset];Create;True;0;0;False;0;-1;None;19dac5600b7ca6341a4051c6b8e0fb63;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;311;-3092.023,2114.786;Inherit;False;Property;_SnowHeightSetting;SnowHeightSetting;10;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-3169.361,2011.41;Inherit;False;Property;_SnowHeight;SnowHeight;9;0;Create;True;0;0;False;0;2;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;155;-4945.869,-2016.774;Float;False;Property;_BaseCellOffset;Base Cell Offset;3;0;Create;True;0;0;False;0;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;156;-6085.326,-3334.105;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;False;0;None;84b09f278b59aa14fa3eba97a0d0cde9;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;310;-2766.414,2009.322;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;-4643.794,-2027.088;Float;False;Property;_BaseCellSharpness;Base Cell Sharpness;2;0;Create;True;0;0;False;0;0.01;0.837;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-4660.517,-2599.351;Float;False;Property;_IndirectDiffuseContribution;Indirect Diffuse Contribution;4;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-4914.127,-3318.409;Float;False;Property;_HighlightCellOffset;Highlight Cell Offset;7;0;Create;True;0;0;False;0;-0.95;-0.95;-1;-0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;181;-4520.866,-3306.193;Float;False;Property;_HighlightCellSharpness;Highlight Cell Sharpness;8;0;Create;True;0;0;False;0;0.01;0.01;0.001;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;189;-3344.153,-1578.838;Float;False;Property;_BaseTint;Base Tint;1;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;276;-4172.571,1106.184;Inherit;False;Property;_SnowEmissive;Snow Emissive;28;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.8352941,0.8352941,0.8352941,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8D6A6A4E0344DFC7BBD94ADFDA44D28D6821DEEB