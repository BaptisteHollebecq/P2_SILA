...
Shader "Custom/ClassicRocks"
{
	Properties
	{
		...
		_SnowAOThreshold("Snow AO Threshold", Float) = 2
		_MeltingParameter("Melting Parameter", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		uniform float _SnowAOThreshold;
		uniform sampler2D _AOTex;
		uniform float4 _AOTex_ST;
		uniform float _MeltingParameter;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_59_0 = ( saturate( ( temp_output_44_0 + ( _SnowAOThreshold * tex2D( _AOTex, uv_AOTex ).r ) ) ) * saturate( ( _MeltingParameter * 2.0 ) ) );
			float4 lerpResult48 = lerp( ( _AlbedoColor + ( saturate( smoothstepResult5 ) * _EdgeColor ) ) , _SnowColor , temp_output_59_0);
			o.Albedo = lerpResult48.rgb;
			float3 normalizeResult20 = normalize( (WorldNormalVector( i , tex2DNode65 )) );
			...
			#endif //aselc
			o.Emission = ( ( ( _SpecularInt * pow( saturate( dotResult19 ) , _SpecularScale ) ) * ase_lightColor ) + ( saturate( temp_output_59_0 ) * _SnowEmission ) ).rgb;
			float lerpResult57 = lerp( _Smoothness , _SnowSmoothness , temp_output_44_0);
...
/*ASEBEGIN
Version=17700
1920;0;1280;659;2370.374;962.2842;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;65;-3793.61,-152.7899;Inherit;True;Property;_NormalTex;Normal Tex;13;1;[Normal];Create;True;0;0;False;0;-1;None;19dac5600b7ca6341a4051c6b8e0fb63;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1630.672,1673.448;Inherit;False;Property;_SnowAOThreshold;Snow AO Threshold;8;0;Create;True;0;0;False;0;2;-17.83;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;31;-1685.783,1888.252;Inherit;True;Property;_AOTex;AO Tex;7;0;Create;True;0;0;False;0;-1;84b09f278b59aa14fa3eba97a0d0cde9;84b09f278b59aa14fa3eba97a0d0cde9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;45;-1264.075,995.9982;Inherit;False;Property;_SnowDeposit;Snow Deposit;10;0;Create;True;0;0;False;0;0;47.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-2056.884,-448.4186;Inherit;False;Property;_EdgeThreshold;Edge Threshold;3;0;Create;True;0;0;False;0;1;0.77;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-2810.225,1434.721;Inherit;False;Property;_MeltingParameter;Melting Parameter;9;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;4;-2177.884,-845.4186;Inherit;True;Property;_CurvatureTex;Curvature Tex;1;0;Create;True;0;0;False;0;-1;3a4dfb4be8fedd84cb3621a660b5d4d9;3a4dfb4be8fedd84cb3621a660b5d4d9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;36;-2452.125,1137.322;Inherit;False;Constant;_MeltingSnowTiming;Melting Snow Timing;11;0;Create;True;0;0;False;0;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-2075.082,1224.627;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;47;-614.9578,1211.34;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;37;-1820.131,1230.896;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;59;-346.6533,1153.188;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightColorNode;30;-1413.108,568.5942;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;69;-720.3632,371.5304;Inherit;False;Property;_SnowEmission;Snow Emission;14;0;Create;True;0;0;False;0;0;0.33;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;2;-1158.263,-769.1295;Inherit;False;Property;_AlbedoColor;Albedo Color;0;0;Create;True;0;0;False;0;0.3490566,0.3490566,0.3490566,0;0.2715379,0.3334901,0.509434,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;58;15.4752,259.6029;Inherit;False;Property;_SnowSmoothness;Snow Smoothness;12;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;50;-477.9971,-192.4818;Inherit;False;Property;_SnowColor;Snow Color;11;0;Create;True;0;0;False;0;0.7830189,0.7830189,0.7830189,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;48;23.0008,-160.7675;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=70134372B727F1A11D007974DEADD7DCBC133854