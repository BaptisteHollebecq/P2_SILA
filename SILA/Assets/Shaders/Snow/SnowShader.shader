...
Shader "SnowShader"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 appendResult363 = (float2(tex2D( _RenderTexture, ( temp_output_41_0 - appendResult356 ) ).r , tex2D( _RenderTexture, ( temp_output_41_0 - appendResult357 ) ).r));
			float4 tex2DNode12 = tex2D( _RenderTexture, temp_output_41_0 );
			float2 temp_cast_0 = (tex2DNode12.r).xx;
			...
			#endif //aseld
			float dotResult135 = dot( BlendNormals( ase_worldNormal , appendResult374 ) , ase_worldlightDir );
			float2 temp_cast_1 = (saturate( dotResult135 )).xx;
			...
			float dotResult302 = dot( reflect( ase_worldlightDir , BlendNormals( appendResult374 , float3( normalizeResult315 ,  0.0 ) ) ) , normalizeResult328 );
			...
			#endif //aselc
			UnityGI gi218 = gi;
			float3 diffNorm218 = WorldNormalVector( i , appendResult374 );
			...
			float dotResult188 = dot( BlendNormals( ase_worldNormal , appendResult374 ) , normalizeResult184 );
			c.rgb = ( ( tex2D( _ToonRamp, temp_cast_1 ) * _ToonRampTint ) + ( saturate( ifLocalVar321 ) * _GlitterIntensity ) + saturate( max( ( temp_output_221_0 * max( saturate( ( pow( ( 1.0 - saturate( dotResult164 ) ) , _RimPower ) * _RimStrenght ) ) , 0.0 ) ) , ( temp_output_221_0 * ( pow( max( 0.0 , dotResult188 ) , _SpecularPower ) * _SpecularStrenght ) ) ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17700
708;73;931;651;351.2469;-126.1537;3.910772;True;False
Node;AmplifyShaderEditor.CommentaryNode;116;-7051.463,1803.879;Inherit;False;3007;698.6722;Comment;19;4;5;57;50;49;47;41;54;58;43;12;3;30;73;36;35;24;76;59;Vertex OffSet;1,0.6687182,0,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-6235.465,2299.879;Inherit;False;Property;_RenderTextureScale;RenderTextureScale;0;0;Create;True;0;0;False;0;0.1;3000;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;49;-6491.465,2235.878;Inherit;False;Property;_PositionPlayer;Position Player;7;1;[HideInInspector];Create;True;0;0;False;0;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;354;-7002.853,1323.786;Inherit;False;Property;_NormalDerivativeOffset;Normal Derivative Offset;17;0;Create;True;0;0;False;0;0;0.51;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;3;-7006.238,1868.577;Inherit;True;Property;_RenderTexture;RenderTexture;10;0;Create;True;0;0;False;0;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-5467.462,2107.878;Inherit;False;Property;_SnowHeight;Snow Height;8;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=337D8F506506B9C92755E9BFEF69A8792DE393F1