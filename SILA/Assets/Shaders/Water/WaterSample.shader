...
Shader "Custom/WaterSample"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			half lerpResult206 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g65*1.0 + ( temp_output_186_0 * i.viewDir ).xy) ).r , 1.0 , 0.9);
			...
			float2 uv_TexCoord9_g67 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_191_0 = ( _ParallaxOffset + temp_output_190_0 );
			half lerpResult208 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g67*1.0 + ( temp_output_191_0 * i.viewDir ).xy) ).r , 1.0 , 0.995);
			float2 uv_TexCoord9_g66 = i.uv_texcoord * _ScaleOffSetIce;
			half lerpResult207 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g66*1.0 + ( ( temp_output_191_0 + _ParallaxOffset ) * i.viewDir ).xy) ).r , 1.0 , 0.9998);
			float2 uv_TexCoord210 = i.uv_texcoord * _ScaleOffSetIce;
			half4 temp_output_222_0 = ( ( ( ( 1.0 - saturate( ( tex2D( _IceParallax, (uv_TexCoord9_g69*1.0 + ( temp_output_185_0 * i.viewDir ).xy) ).r * lerpResult206 * lerpResult202 * lerpResult203 * lerpResult205 * lerpResult204 * lerpResult208 * lerpResult207 ) ) ) * _Color1 ) + ( tex2D( _Albedo, uv_TexCoord210 ) * _IceColor ) ) + ( ( 1.0 - tex2D( _IceParallax, uv_TexCoord210 ).r ) * _Color3 ) );
...
/*ASEBEGIN
Version=17700
336;73;1036;656;1734.735;4257.898;2.332066;True;False
...
Node;AmplifyShaderEditor.FunctionNode;196;-3459.776,-1915.897;Inherit;False;ParallaxOffset;-1;;67;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;198;-3475.776,-1579.897;Inherit;False;ParallaxOffset;-1;;66;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;200;-3507.776,-3595.896;Inherit;False;ParallaxOffset;-1;;65;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;224;-3507.776,-3819.897;Inherit;False;ParallaxOffset;-1;;69;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=A51BD4B9E2AE46863A9D6756F3CE590ADD8D0F89