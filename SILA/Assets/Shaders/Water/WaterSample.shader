...
Shader "Custom/WaterSample"
{
	Properties
	{
		...
		_IceTransparency("Ice Transparency", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			half4 lerpResult181 = lerp( tex2D( _IceNormal, uv_IceNormal ) , half4( temp_output_24_0 , 0.0 ) , clampResult171);
			o.Normal = lerpResult181.rgb;
			float2 uv_TexCoord9_g39 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_185_0 = ( _ParallaxOffset + 0.0 );
			float2 uv_TexCoord9_g37 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_186_0 = ( _ParallaxOffset + temp_output_185_0 );
			half lerpResult206 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g37*1.0 + ( temp_output_186_0 * i.viewDir ).xy) ).r , 1.0 , 0.9);
			float2 uv_TexCoord9_g38 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_187_0 = ( temp_output_186_0 + _ParallaxOffset );
			half lerpResult202 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g38*1.0 + ( temp_output_187_0 * i.viewDir ).xy) ).r , 1.0 , 0.95);
			float2 uv_TexCoord9_g34 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_188_0 = ( _ParallaxOffset + temp_output_187_0 );
			half lerpResult203 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g34*1.0 + ( temp_output_188_0 * i.viewDir ).xy) ).r , 1.0 , 0.97);
			float2 uv_TexCoord9_g36 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_189_0 = ( temp_output_188_0 + _ParallaxOffset );
			half lerpResult205 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g36*1.0 + ( temp_output_189_0 * i.viewDir ).xy) ).r , 1.0 , 0.98);
			float2 uv_TexCoord9_g32 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_190_0 = ( _ParallaxOffset + temp_output_189_0 );
			half lerpResult204 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g32*1.0 + ( temp_output_190_0 * i.viewDir ).xy) ).r , 1.0 , 0.99);
			float2 uv_TexCoord9_g33 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_191_0 = ( _ParallaxOffset + temp_output_190_0 );
			half lerpResult208 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g33*1.0 + ( temp_output_191_0 * i.viewDir ).xy) ).r , 1.0 , 0.995);
			float2 uv_TexCoord9_g35 = i.uv_texcoord * _ScaleOffSetIce;
			half lerpResult207 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g35*1.0 + ( ( temp_output_191_0 + _ParallaxOffset ) * i.viewDir ).xy) ).r , 1.0 , 0.9998);
			float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( ase_screenPos );
			half4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
			half4 screenColor232 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture,(ase_grabScreenPosNorm).xy);
			half4 temp_output_236_0 = ( screenColor232 * _IceTransparency );
			...
			half4 lerpResult93 = lerp( ( ( ( ( ( ( 1.0 - saturate( ( tex2D( _IceParallax, (uv_TexCoord9_g39*1.0 + ( temp_output_185_0 * i.viewDir ).xy) ).r * lerpResult206 * lerpResult202 * lerpResult203 * lerpResult205 * lerpResult204 * lerpResult208 * lerpResult207 ) ) ) * _Color1 ) * temp_output_236_0 ) + ( tex2D( _Albedo, uv_TexCoord210 ) * _IceColor ) ) * temp_output_236_0 ) + ( ( 1.0 - tex2D( _IceParallax, uv_TexCoord210 ).r ) * _Color3 ) ) , screenColor65 , clampResult171);
			o.Albedo = lerpResult93.rgb;
			half lerpResult130 = lerp( _IceSpecular , _WaterSpecular , clampResult171);
			half3 temp_cast_15 = (lerpResult130).xxx;
			o.Specular = temp_cast_15;
...
/*ASEBEGIN
Version=17700
335;73;1037;656;-758.2418;1188.706;1.998853;True;False
Node;AmplifyShaderEditor.RangedFloatNode;184;-4419.775,-3787.897;Inherit;False;Property;_ParallaxOffset;Parallax Offset;9;0;Create;True;0;0;False;0;-1.58;-0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;198;-3475.776,-1579.897;Inherit;False;ParallaxOffset;-1;;35;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;195;-3459.776,-2299.896;Inherit;False;ParallaxOffset;-1;;32;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;201;-3491.776,-3275.896;Inherit;False;ParallaxOffset;-1;;38;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;196;-3459.776,-1915.897;Inherit;False;ParallaxOffset;-1;;33;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;199;-3507.776,-2555.896;Inherit;False;ParallaxOffset;-1;;36;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;200;-3507.776,-3595.896;Inherit;False;ParallaxOffset;-1;;37;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;197;-3539.776,-2875.896;Inherit;False;ParallaxOffset;-1;;34;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;224;-3507.776,-3819.897;Inherit;False;ParallaxOffset;-1;;39;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;167;-2340.698,-750.8057;Inherit;False;Property;_WaveSpeed;Wave Speed;2;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-2020.991,-742.4124;Float;False;Property;_NormalScale;Normal Scale;1;0;Create;True;0;0;False;0;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;17;-1719.99,-761.3113;Inherit;True;Property;_WaterNormal;Water Normal;0;0;Create;True;0;0;False;0;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;215;-1739.139,-4194.071;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;214;-1557.152,-3959.16;Inherit;False;Property;_Color1;Color 1;12;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;213;-2403.775,-4379.896;Inherit;False;Property;_IceColor;Ice Color;10;1;[HDR];Create;True;0;0;False;0;0,2.682353,4,0;0.7387707,0.8198553,0.8603976,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;241;-1036.362,-4156.963;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;97;-740.0237,-743.2466;Float;False;Property;_Distortion;Distortion;5;0;Create;True;0;0;False;0;0.5;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;226;-1242.246,49.60068;Inherit;False;Property;_Glaciation;Glaciation;18;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;169;-1180.207,-182.6573;Inherit;False;Property;_Dist;Dist;7;0;Create;True;0;0;False;0;650;6500;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;242;-538.5007,-4229.822;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;920.1959,-279.1855;Float;False;Property;_WaterSmoothness;Water Smoothness;4;0;Create;True;0;0;False;0;0;0.9;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;132;914.3978,-199.48;Float;False;Property;_IceSmoothness;Ice Smoothness;15;0;Create;True;0;0;False;0;0;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;131;756.1969,-467.1806;Float;False;Property;_IceSpecular;Ice Specular;14;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;104;753.9969,-565.4819;Float;False;Property;_WaterSpecular;Water Specular;3;0;Create;True;0;0;False;0;0;0.05;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;183;1003.588,-943.3737;Inherit;True;Property;_IceNormal;Ice Normal;8;0;Create;True;0;0;False;0;-1;None;None;True;0;False;bump;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;181;1554.643,-780.2902;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=20538CA52B7B628BE1D3A8D03A4BB82DA15AA8A5