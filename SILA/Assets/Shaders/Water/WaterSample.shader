...
Shader "Custom/WaterSample"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 uv_TexCoord9_g57 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_185_0 = ( _ParallaxOffset + 0.0 );
			float2 uv_TexCoord9_g50 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_186_0 = ( _ParallaxOffset + temp_output_185_0 );
			half lerpResult206 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g50*1.0 + ( temp_output_186_0 * i.viewDir ).xy) ).r , 1.0 , 0.9);
			float2 uv_TexCoord9_g53 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_187_0 = ( temp_output_186_0 + _ParallaxOffset );
			half lerpResult202 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g53*1.0 + ( temp_output_187_0 * i.viewDir ).xy) ).r , 1.0 , 0.95);
			float2 uv_TexCoord9_g55 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_188_0 = ( _ParallaxOffset + temp_output_187_0 );
			half lerpResult203 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g55*1.0 + ( temp_output_188_0 * i.viewDir ).xy) ).r , 1.0 , 0.97);
			float2 uv_TexCoord9_g54 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_189_0 = ( temp_output_188_0 + _ParallaxOffset );
			half lerpResult205 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g54*1.0 + ( temp_output_189_0 * i.viewDir ).xy) ).r , 1.0 , 0.98);
			float2 uv_TexCoord9_g56 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_190_0 = ( _ParallaxOffset + temp_output_189_0 );
			half lerpResult204 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g56*1.0 + ( temp_output_190_0 * i.viewDir ).xy) ).r , 1.0 , 0.99);
			float2 uv_TexCoord9_g51 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_191_0 = ( _ParallaxOffset + temp_output_190_0 );
			half lerpResult208 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g51*1.0 + ( temp_output_191_0 * i.viewDir ).xy) ).r , 1.0 , 0.995);
			float2 uv_TexCoord9_g52 = i.uv_texcoord * _ScaleOffSetIce;
			half lerpResult207 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g52*1.0 + ( ( temp_output_191_0 + _ParallaxOffset ) * i.viewDir ).xy) ).r , 1.0 , 0.9998);
			float2 uv_TexCoord210 = i.uv_texcoord * _ScaleOffSetIce;
			half4 temp_output_222_0 = ( ( ( ( 1.0 - saturate( ( tex2D( _IceParallax, (uv_TexCoord9_g57*1.0 + ( temp_output_185_0 * i.viewDir ).xy) ).r * lerpResult206 * lerpResult202 * lerpResult203 * lerpResult205 * lerpResult204 * lerpResult208 * lerpResult207 ) ) ) * _Color1 ) + ( tex2D( _Albedo, uv_TexCoord210 ) * _IceColor ) ) + ( ( 1.0 - tex2D( _IceParallax, uv_TexCoord210 ).r ) * _Color3 ) );
			...
			half4 lerpResult93 = lerp( ( temp_output_222_0 + distanceDepth244 ) , screenColor65 , clampResult171);
...
/*ASEBEGIN
Version=17700
335;73;1037;656;2913.408;2038.308;5.01367;True;False
...
Node;AmplifyShaderEditor.FunctionNode;199;-3507.776,-2555.896;Inherit;False;ParallaxOffset;-1;;54;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;197;-3539.776,-2875.896;Inherit;False;ParallaxOffset;-1;;55;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;195;-3459.776,-2299.896;Inherit;False;ParallaxOffset;-1;;56;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;201;-3491.776,-3275.896;Inherit;False;ParallaxOffset;-1;;53;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;198;-3475.776,-1579.897;Inherit;False;ParallaxOffset;-1;;52;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;196;-3459.776,-1915.897;Inherit;False;ParallaxOffset;-1;;51;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;200;-3507.776,-3595.896;Inherit;False;ParallaxOffset;-1;;50;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;224;-3507.776,-3819.897;Inherit;False;ParallaxOffset;-1;;57;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-2020.991,-742.4124;Float;False;Property;_NormalScale;Normal Scale;1;0;Create;True;0;0;False;0;0;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;214;-1557.152,-3959.16;Inherit;False;Property;_Color1;Color 1;12;1;[HDR];Create;True;0;0;False;0;0,0,0,0;3.232786,3.232786,3.232786,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;213;-2403.775,-4379.896;Inherit;False;Property;_IceColor;Ice Color;10;1;[HDR];Create;True;0;0;False;0;0,2.682353,4,0;7.699717,13.99196,15.8134,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;223;-832.8113,-4453.232;Inherit;False;Property;_Color3;Color 3;13;1;[HDR];Create;True;0;0;False;0;0,0,0,0;7.129739,7.129739,7.129739,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;169;-1180.207,-182.6573;Inherit;False;Property;_Dist;Dist;7;0;Create;True;0;0;False;0;1500;961.32;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;245;-1007.962,-3555.68;Inherit;False;Property;_DepthTransparency;Depth Transparency;19;0;Create;True;0;0;False;0;0;75.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;920.1959,-279.1855;Float;False;Property;_WaterSmoothness;Water Smoothness;4;0;Create;True;0;0;False;0;0;0.909;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;183;1003.588,-943.3737;Inherit;True;Property;_IceNormal;Ice Normal;8;0;Create;True;0;0;False;0;-1;None;aa890fa9565d5b64b8dc4d4241aa9482;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;131;756.1969,-467.1806;Float;False;Property;_IceSpecular;Ice Specular;14;0;Create;True;0;0;False;0;0;0.843;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;104;753.9969,-565.4819;Float;False;Property;_WaterSpecular;Water Specular;3;0;Create;True;0;0;False;0;0;0.068;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;132;914.3978,-199.48;Float;False;Property;_IceSmoothness;Ice Smoothness;15;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;246;-80.42958,-3582.625;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;251;-427.0464,-3432.063;Inherit;False;Property;_Float0;Float 0;20;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=29C089BB2E13B39B5AD4A27A083BD84EEDBA6339