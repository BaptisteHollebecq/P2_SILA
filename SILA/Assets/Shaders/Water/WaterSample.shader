...
Shader "Custom/WaterSample"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 uv_TexCoord9_g65 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_185_0 = ( _ParallaxOffset + 0.0 );
			float2 uv_TexCoord9_g61 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_186_0 = ( _ParallaxOffset + temp_output_185_0 );
			half lerpResult206 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g61*1.0 + ( temp_output_186_0 * i.viewDir ).xy) ).r , 1.0 , 0.9);
			float2 uv_TexCoord9_g57 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_187_0 = ( temp_output_186_0 + _ParallaxOffset );
			half lerpResult202 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g57*1.0 + ( temp_output_187_0 * i.viewDir ).xy) ).r , 1.0 , 0.95);
			float2 uv_TexCoord9_g63 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_188_0 = ( _ParallaxOffset + temp_output_187_0 );
			half lerpResult203 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g63*1.0 + ( temp_output_188_0 * i.viewDir ).xy) ).r , 1.0 , 0.97);
			float2 uv_TexCoord9_g64 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_189_0 = ( temp_output_188_0 + _ParallaxOffset );
			half lerpResult205 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g64*1.0 + ( temp_output_189_0 * i.viewDir ).xy) ).r , 1.0 , 0.98);
			float2 uv_TexCoord9_g62 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_190_0 = ( _ParallaxOffset + temp_output_189_0 );
			half lerpResult204 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g62*1.0 + ( temp_output_190_0 * i.viewDir ).xy) ).r , 1.0 , 0.99);
			float2 uv_TexCoord9_g59 = i.uv_texcoord * _ScaleOffSetIce;
			half temp_output_191_0 = ( _ParallaxOffset + temp_output_190_0 );
			half lerpResult208 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g59*1.0 + ( temp_output_191_0 * i.viewDir ).xy) ).r , 1.0 , 0.995);
			float2 uv_TexCoord9_g60 = i.uv_texcoord * _ScaleOffSetIce;
			half lerpResult207 = lerp( tex2D( _IceParallax, (uv_TexCoord9_g60*1.0 + ( ( temp_output_191_0 + _ParallaxOffset ) * i.viewDir ).xy) ).r , 1.0 , 0.9998);
			float2 uv_TexCoord210 = i.uv_texcoord * _ScaleOffSetIce;
			half4 temp_output_222_0 = ( ( ( ( 1.0 - saturate( ( tex2D( _IceParallax, (uv_TexCoord9_g65*1.0 + ( temp_output_185_0 * i.viewDir ).xy) ).r * lerpResult206 * lerpResult202 * lerpResult203 * lerpResult205 * lerpResult204 * lerpResult208 * lerpResult207 ) ) ) * _Color1 ) + ( tex2D( _Albedo, uv_TexCoord210 ) * _IceColor ) ) + ( ( 1.0 - tex2D( _IceParallax, uv_TexCoord210 ).r ) * _Color3 ) );
...
/*ASEBEGIN
Version=17700
336;73;1036;656;1294.918;4063.007;1.769758;True;False
...
Node;AmplifyShaderEditor.FunctionNode;195;-3459.776,-2299.896;Inherit;False;ParallaxOffset;-1;;62;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;197;-3539.776,-2875.896;Inherit;False;ParallaxOffset;-1;;63;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;199;-3507.776,-2555.896;Inherit;False;ParallaxOffset;-1;;64;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;200;-3507.776,-3595.896;Inherit;False;ParallaxOffset;-1;;61;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;198;-3475.776,-1579.897;Inherit;False;ParallaxOffset;-1;;60;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;196;-3459.776,-1915.897;Inherit;False;ParallaxOffset;-1;;59;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;201;-3491.776,-3275.896;Inherit;False;ParallaxOffset;-1;;57;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;224;-3507.776,-3819.897;Inherit;False;ParallaxOffset;-1;;65;24c505475a2d60f47a386774fff313d4;0;3;11;FLOAT2;0,0;False;7;SAMPLER2D;;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;226;-1242.246,49.60068;Inherit;False;Property;_Glaciation;Glaciation;18;0;Create;True;0;0;False;0;0;0.5;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C1D0684EFE00C1F542ED07C2466ABC758A4AD57F