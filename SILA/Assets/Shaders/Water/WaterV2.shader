...
Shader "WaterV2"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float smoothstepResult208 = smoothstep( _Glaciation , _Glaciation , tex2Dlod( _Vignette, float4( uv_TexCoord210, 0, 0.0) ).r);
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float smoothstepResult208 = smoothstep( _Glaciation , _Glaciation , tex2D( _Vignette, uv_TexCoord210 ).r);
			float temp_output_212_0 = ( 1.0 - smoothstepResult208 );
			...
			float4 temp_output_253_0 = ( ( ( ( 1.0 - tex2D( _IceParallax, Offset230 ).r ) + ( 1.0 - tex2D( _IceParallax, Offset235 ).r ) + ( 1.0 - tex2D( _IceParallax, Offset237 ).r ) ) * _ParallaxColor ) + ( tex2D( _IceAlbedo, uv0_IceAlbedo ) * _IceColor ) );
			float4 temp_output_258_0 = ( temp_output_196_0 * 0.2 );
			float4 temp_output_261_0 = ( temp_output_253_0 + temp_output_258_0 );
			float4 lerpResult215 = lerp( lerpResult118 , temp_output_261_0 , temp_output_212_0);
			...
			#endif //aselc
			float4 lerpResult214 = lerp( ( ( _FoamColor * temp_output_128_0 ) + float4( ( pow( saturate( dotResult165 ) , _SpecularInt ) * ase_lightColor.rgb ) , 0.0 ) ) , temp_output_261_0 , temp_output_212_0);
...
/*ASEBEGIN
Version=17700
462;73;885;655;447.4678;906.6478;1.101864;True;False
...
Node;AmplifyShaderEditor.ColorNode;229;-321.1269,-612.1934;Inherit;False;Property;_IceColor;Ice Color;21;1;[HDR];Create;True;0;0;False;0;0,0,0,0;2.670157,2.670157,2.670157,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-1138.156,928.0911;Inherit;False;Property;_Glaciation;Glaciation;19;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;260;-23.28817,-574.1068;Inherit;False;Constant;_Float0;Float 0;29;0;Create;True;0;0;False;0;0.2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;258;142.6058,-692.1877;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;261;509.8714,-719.0946;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;227;349.656,-436.7903;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1320.156,-3.157014;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;WaterV2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Absolute;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=10F081B3CA7353C4140A359111C0CBE3F63F5831